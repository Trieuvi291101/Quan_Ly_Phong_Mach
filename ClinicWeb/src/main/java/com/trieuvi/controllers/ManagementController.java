...
public class ManagementController {
    ...
    @RequestMapping("/management/remove/{medicineId}")
    public String Delete(@PathVariable(value = "medicineId") Medicine p){
        
        if (this.managementService.deleteMedicine(p) == true)
            return "redirect:/management";
        
        return "management/remove/medicineId";
    }
